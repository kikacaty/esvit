...
def extract_feature_c_pipeline(args, c, s):
    ...
    if args.zip_mode:
        ...
        # dataset_train = ReturnIndexDataset(os.path.join(args.data_path, "train"), transform=transform)
        # dataset_val = ReturnIndexDataset(os.path.join(, "val"), transform=transform)
        dataset_val = ReturnIndexDataset(os.path.join(args.cdata_path, c, str(s)), transform=transform)
        dataset_val = ReturnIndexDataset(os.path.join("/home/scratch.sysarch_nvresearch/chaowei/datasets/imagenet/imagenet-c", c, str(s)), transform=transform)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cdata_path', default='/home/scratch.sysarch_nvresearch/chaowei/datasets/imagenet/imagenet-c', type=str)
